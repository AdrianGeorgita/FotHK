...
/*! \class public class Enemy2 extends Character
...
public class Enemy2 extends Character
{
    ...
    /*! \fn public Enemy2(RefLinks refLink, float x, float y)
     ...
     */
    public Enemy2(RefLinks refLink, float x, float y, int id)
    {
        ...
        if(!attacking) {
            switch (animationIndex) {
                case 1:
                    ...
                    break;
                case 2:
                    image = Assets.enemy2Idle2;
                    break;
                case 3:
                    image = Assets.enemy2Idle3;
                    break;
                case 4:
                    image = Assets.enemy2Idle4;
                    break;
            }
        }
