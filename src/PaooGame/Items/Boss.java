...
public class Boss extends Character
{
     ...
     */
    public Boss(RefLinks refLink, float x, float y, int id)
    {
        ///Apel al constructorului clasei de baza
        super(refLink, x,y, 96, 96,id);

        characterPoints = 5000;
        life = 1000;
        maxLife = life;
        speed = 1.25f;
        damage = 50;
    ...
    public void Update(){
        ...
        if(!attacking) {
            switch (animationIndex) {
                case 1:
                    ...
                    break;
                case 2:
                    image = Assets.bossIdle2;
                    break;
                case 3:
                    image = Assets.bossIdle3;
                    break;
                case 4:
                    image = Assets.bossIdle4;
                    break;
            }
        }
        ...
        if(hero.x+hero.normalBounds.x+hero.normalBounds.width > x+normalBounds.x-TileSize*4 && hero.x+hero.normalBounds.x <= x+normalBounds.x && hero.y+hero.normalBounds.y+hero.normalBounds.height <= y+normalBounds.y+ normalBounds.height && hero.y+hero.normalBounds.y >= y+normalBounds.y-TileSize*4) {
            ...
            if(!CheckCollision(xTile,yTile1) && !CheckCollision(xTile,yTile2) && !CheckCollision(xTile,(yTile1+yTile2)/2)){
                if(initialX-TileSize*8<x && hero.x + hero.normalBounds.x + hero.normalBounds.width <= x+normalBounds.x-TileSize*2) {
                    xMove = -speed;
            ...
            if (hero.x + hero.normalBounds.x + hero.normalBounds.width > x + normalBounds.x + normalBounds.width && hero.x + hero.normalBounds.x < x + normalBounds.x + normalBounds.width + TileSize*4 && hero.y + hero.normalBounds.y + hero.normalBounds.height <= y + normalBounds.y + normalBounds.height + TileSize * 4 && hero.y + hero.normalBounds.y >= y+ normalBounds.y-TileSize) {
                ...
                if(!CheckCollision(xTile,yTile1) && !CheckCollision(xTile,yTile2) && !CheckCollision(xTile,(yTile1+yTile2)/2)){
                    if(initialX+TileSize*8>x && hero.x + hero.normalBounds.x <= x+normalBounds.x+ normalBounds.width+TileSize*2) {
                ...
                if (hero.x+hero.normalBounds.x >= x+ normalBounds.x-TileSize*4 && hero.x+hero.normalBounds.x+hero.normalBounds.width <= x+normalBounds.x+ normalBounds.width && hero.y+hero.normalBounds.y+hero.normalBounds.height >= y+normalBounds.y+ normalBounds.height-TileSize && hero.y+hero.normalBounds.y <= y+ normalBounds.y+ normalBounds.height+TileSize*4) {
                    ...
                    if(!CheckCollision(xTile1,yTile) && !CheckCollision(xTile2,yTile) && !CheckCollision((xTile1+xTile2)/2,yTile)){
                        if(initialY+TileSize*8>y && hero.y+hero.normalBounds.y <= y+normalBounds.y+ normalBounds.height+TileSize*2) {
                    ...
                    if (hero.x+hero.normalBounds.x >= x+ normalBounds.x && hero.x+hero.normalBounds.x+hero.normalBounds.width <= x+ normalBounds.x+ normalBounds.width+TileSize*4 && hero.y+hero.normalBounds.y <= y+ normalBounds.y && hero.y+hero.normalBounds.y+hero.normalBounds.height >= y+ normalBounds.y-TileSize*4) {
                        ...
                        if(!CheckCollision(xTile1,yTile) && !CheckCollision(xTile2,yTile) && !CheckCollision((xTile1+xTile2)/2,yTile)){
                            if(initialY-TileSize*8<y && y+normalBounds.y-TileSize*2 <= hero.y+hero.normalBounds.y+hero.normalBounds.height+TileSize*2) {
        ...
        if(attackingCounter<150)
            attackingCounter++;
        else {
            attackingCounter = 0;

            if ((x + normalBounds.x - (hero.x + hero.normalBounds.x + hero.normalBounds.width) <= TileSize * 8) && (x + normalBounds.x - (hero.x + hero.normalBounds.x + hero.normalBounds.width) > 0)) {
                if (y + normalBounds.y + TileSize * 2 >= hero.y + hero.normalBounds.y && y + normalBounds.y + normalBounds.height - TileSize * 2 <= hero.y + hero.normalBounds.y + hero.normalBounds.height) {
                    ...
                    Projectile fireball = new Projectile(refLink, x - 64, y+16, 0, 0, 2, damage, 400);
                    //System.out.println("LEFT");
                    refLink.AddProjectiles(fireball);
                }
            }
            if (hero.x + hero.normalBounds.x - (x + normalBounds.x + normalBounds.x) <= TileSize * 8 && hero.x + hero.normalBounds.x - (x + normalBounds.x + normalBounds.x) > 0) {
                if (y + normalBounds.y + TileSize * 2 >= hero.y + hero.normalBounds.y && y + normalBounds.y + normalBounds.height - TileSize * 2 <= hero.y + hero.normalBounds.y + hero.normalBounds.height) {
                    Projectile fireball = new Projectile(refLink, x + 64, y+16, 0, 1, 2, damage, 400);
                    //System.out.println("RIGHT");
                    refLink.AddProjectiles(fireball);
                }
            }
            if (hero.y + hero.normalBounds.y - (y + normalBounds.y + normalBounds.height) <= TileSize * 8 && hero.y + hero.normalBounds.y - (y + normalBounds.y + normalBounds.height) > 0) {
                if (x + normalBounds.x + TileSize * 2 >= hero.x + hero.normalBounds.x && x + normalBounds.x + normalBounds.width - TileSize * 2 <= hero.x + hero.normalBounds.x + hero.normalBounds.width) {
                    Projectile fireball = new Projectile(refLink, x + normalBounds.x, y + normalBounds.x + normalBounds.height + 16, 0, 3, 2, damage, 400);
                    //System.out.println("DOWN");
                    refLink.AddProjectiles(fireball);
                }
            }
            if (y + normalBounds.y - (hero.y + hero.normalBounds.y + hero.normalBounds.height) <= TileSize * 8 && y + normalBounds.y - (hero.y + hero.normalBounds.y + hero.normalBounds.height) > 0) {
                if (x + normalBounds.x + TileSize * 2 >= hero.x + hero.normalBounds.x && x + normalBounds.x + normalBounds.width - TileSize * 2 <= hero.x + hero.normalBounds.x + hero.normalBounds.width) {
                    Projectile fireball = new Projectile(refLink, x - 24, y + 64, 0, 2, 2, damage, 400);
