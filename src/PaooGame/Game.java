...
public class Game implements Runnable
{
    ...
    private final int initialTileSize = 16;
    private final int scale = 3;

    private final int tileSize = initialTileSize * scale;
    private final int maxScreenCol = 20;
    private final int maxScerenRow = 12;

    private final int screenWidth = tileSize * maxScreenCol;
    private final int screenHeight = tileSize * maxScerenRow;
    ...
    public Game(String title)
    {
        ...
        wnd = new GameWindow(title, screenWidth, screenHeight);
