...
public class SpriteSheet
{
    ...
    /// Permite obtinerea unei imagini cu dimensiunea diferita fata de cea prestabilita.
    /// Se folosesc doi intregi pentru a scala dimensiunea.
    public BufferedImage cropScale(int x, int y,int scaleX,int scaleY)
    {
        /// Subimaginea (dala) este regasita in sprite sheet specificad coltul stanga sus
        /// al imaginii si apoi latimea si inaltimea (totul in pixeli). Coltul din stanga sus al imaginii
        /// se obtine inmultind numarul de ordine al dalei cu dimensiunea in pixeli a unei dale.
        return spriteSheet.getSubimage(x * tileWidth, y * tileHeight, tileWidth*scaleX, tileHeight*scaleY);
    }
}
